...
public class RegionalDivisionHelper {
    ...
    public static String selectRegionalDivision(int dbUniqueID, String comp, boolean allRegionalDivisions) {
        int fmxmlIDVersion = ClubCreator.FM_XML_ID_VERSION;

        if (comp.contains("Bornholm")) {
            return bornholm(dbUniqueID, fmxmlIDVersion, allRegionalDivisions);
        } else if (comp.contains("Copenhagen")) {
            return copenhagen(dbUniqueID, fmxmlIDVersion, allRegionalDivisions);
        } else if (comp.contains("Zealand")) {
            return zealand(dbUniqueID, fmxmlIDVersion, allRegionalDivisions);
        } else if (comp.contains("Lolland-Falster")) {
            return lollandFalster(dbUniqueID, fmxmlIDVersion, allRegionalDivisions);
        } else if (comp.contains("Funen")) {
            return funen(dbUniqueID, fmxmlIDVersion, allRegionalDivisions);
        } else if (comp.contains("Jutland")) {
            return jutland(dbUniqueID, fmxmlIDVersion, allRegionalDivisions);
        }
        return "";
    }

    public static String copenhagen(int dbUniqueID, int fmxmlIDVersion, boolean allRegionalDivisions) {
        return (allRegionalDivisions ? copenhagenBase(dbUniqueID, fmxmlIDVersion) : "") +
    ...
    public static String bornholm(int dbUniqueID, int fmxmlIDVersion, boolean allRegionalDivisions) {
        return (allRegionalDivisions ? copenhagenBase(dbUniqueID, fmxmlIDVersion) : "") +
                //Regional Division add
                "\t\t<record>\n" +
                "\t\t\t<integer id=\"database_table_type\" value=\"3\"/>\n" +
    ...
    public static String zealand(int dbUniqueID, int fmxmlIDVersion, boolean allRegionalDivisions) {
        return (allRegionalDivisions ? zealandBase(dbUniqueID, fmxmlIDVersion) : "") +
                //Regional Division add
                "\t\t<record>\n" +
                "\t\t\t<integer id=\"database_table_type\" value=\"3\"/>\n" +
                "\t\t\t<large id=\"db_unique_id\" value=\"" + dbUniqueID + "\"/>\n" +
    ...
    public static String lollandFalster(int dbUniqueID, int fmxmlIDVersion, boolean allRegionalDivisions) {
        return (allRegionalDivisions ? zealandBase(dbUniqueID, fmxmlIDVersion) : "") +
                //Regional Division add
                "\t\t<record>\n" +
                "\t\t\t<integer id=\"database_table_type\" value=\"3\"/>\n" +
    ...
    public static String funen(int dbUniqueID, int fmxmlIDVersion, boolean allRegionalDivisions) {
        return (allRegionalDivisions ? funenBase(dbUniqueID, fmxmlIDVersion) : "") +
                //Regional Division add
                "\t\t<record>\n" +
                "\t\t\t<integer id=\"database_table_type\" value=\"3\"/>\n" +
                "\t\t\t<large id=\"db_unique_id\" value=\"" + dbUniqueID + "\"/>\n" +
    ...
    public static String funenBase(int dbUniqueID, int fmxmlIDVersion) {
    ...
    public static String jutland(int dbUniqueID, int fmxmlIDVersion, boolean allRegionalDivisions) {
        return (allRegionalDivisions ? jutlandBase(dbUniqueID, fmxmlIDVersion) : "") +
                //Regional Division add
                "\t\t<record>\n" +
                "\t\t\t<integer id=\"database_table_type\" value=\"3\"/>\n" +
                "\t\t\t<large id=\"db_unique_id\" value=\"" + dbUniqueID + "\"/>\n" +
    ...
    public static String jutlandBase(int dbUniqueID, int fmxmlIDVersion) {
